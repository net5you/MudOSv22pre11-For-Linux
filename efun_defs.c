...
{"call_out",F_CALL_OUT,0,0,2,-1,TYPE_NOVALUE,T_STRING|T_FUNCTION,T_NUMBER,T_ANY,T_ANY,38,DEFAULT_NONE},
...
{"crc32",F_CRC32,0,0,1,1,TYPE_NUMBER,T_STRING|T_BUFFER,T_ANY,T_ANY,T_ANY,141,DEFAULT_NONE},
...
{"debug_info",F_DEBUG_INFO,0,0,2,2,TYPE_ANY,T_NUMBER,T_OBJECT,T_ANY,T_ANY,170,DEFAULT_NONE},
...
{"dump_prog",F_DUMP_PROG,0,0,1,-1,TYPE_NOVALUE,T_OBJECT,T_ANY,T_ANY,T_ANY,288,DEFAULT_NONE},
...
{"ed",F_ED,0,0,0,4,TYPE_NOVALUE,T_STRING,T_STRING,T_STRING|T_NUMBER,T_NUMBER,200,DEFAULT_NONE},
...
{"exec",F_EXEC,0,0,2,2,TYPE_NUMBER,T_OBJECT,T_OBJECT,T_ANY,T_ANY,172,DEFAULT_NONE},
...
{"filter",F_FILTER,0,0,2,-1,TYPE_ANY,T_ARRAY|T_MAPPING,T_STRING|T_FUNCTION,T_ANY,T_ANY,209,DEFAULT_NONE},
{"filter_array",F_FILTER | F_ALIAS_FLAG,0,0,2,-1,TYPE_ANY,T_ARRAY,T_STRING|T_FUNCTION,T_ANY,T_ANY,194,DEFAULT_NONE},
{"filter_mapping",F_FILTER | F_ALIAS_FLAG,0,0,2,-1,TYPE_MAPPING,T_MAPPING,T_STRING|T_FUNCTION,T_ANY,T_ANY,210,DEFAULT_NONE},
{"find_call_out",F_FIND_CALL_OUT,0,0,1,1,TYPE_NUMBER,T_STRING,T_ANY,T_ANY,T_ANY,20,DEFAULT_NONE},
...
{"function_exists",F_FUNCTION_EXISTS,0,0,1,3,TYPE_STRING,T_STRING,T_OBJECT,T_NUMBER,T_ANY,176,DEFAULT_NONE},
...
{"functions",F_FUNCTIONS,0,0,2,2,TYPE_MOD_ARRAY|TYPE_STRING,T_OBJECT,T_NUMBER,T_ANY,T_ANY,178,0},
{"generate_source",F_GENERATE_SOURCE,0,0,1,2,TYPE_NUMBER,T_STRING|T_ARRAY,T_STRING,T_ANY,T_ANY,126,DEFAULT_NONE},
...
{"geteuid",F_GETEUID,0,0,1,1,TYPE_STRING,T_FUNCTION|T_OBJECT,T_ANY,T_ANY,T_ANY,224,DEFAULT_THIS_OBJECT},
...
{"keys",F_KEYS,0,0,1,1,TYPE_MOD_ARRAY|TYPE_ANY,T_MAPPING,T_ANY,T_ANY,T_ANY,116,DEFAULT_NONE},
...
{"map",F_MAP,0,0,2,-1,TYPE_ANY,T_STRING|T_MAPPING|T_ARRAY,T_STRING|T_FUNCTION,T_ANY,T_ANY,216,DEFAULT_NONE},
{"map_array",F_MAP | F_ALIAS_FLAG,0,0,2,-1,TYPE_MOD_ARRAY|TYPE_ANY,T_ARRAY,T_STRING|T_FUNCTION,T_ANY,T_ANY,194,DEFAULT_NONE},
{"map_delete",F_MAP_DELETE,0,0,2,2,TYPE_NOVALUE,T_MAPPING,T_ANY,T_ANY,T_ANY,118,DEFAULT_NONE},
{"map_mapping",F_MAP | F_ALIAS_FLAG,0,0,2,-1,TYPE_MAPPING,T_MAPPING,T_STRING|T_FUNCTION,T_ANY,T_ANY,210,DEFAULT_NONE},
...
{"match_path",F_MATCH_PATH,0,0,2,2,TYPE_ANY,T_MAPPING,T_STRING,T_ANY,T_ANY,122,DEFAULT_NONE},
...
{"objects",F_OBJECTS,0,0,0,2,TYPE_MOD_ARRAY|TYPE_OBJECT,T_STRING|T_FUNCTION,T_OBJECT,T_ANY,T_ANY,182,DEFAULT_NONE},
...
{"read_buffer",F_READ_BUFFER,0,0,1,3,TYPE_ANY,T_STRING|T_BUFFER,T_NUMBER,T_NUMBER,T_ANY,144,DEFAULT_NONE},
{"read_bytes",F_READ_BYTES,0,0,1,3,TYPE_STRING,T_STRING,T_NUMBER,T_NUMBER,T_ANY,166,DEFAULT_NONE},
{"read_file",F_READ_FILE,0,0,1,3,TYPE_STRING,T_STRING,T_NUMBER,T_NUMBER,T_ANY,166,DEFAULT_NONE},
...
{"reg_assoc",F_REG_ASSOC,0,0,3,4,TYPE_MOD_ARRAY|TYPE_ANY,T_STRING,T_ARRAY,T_ARRAY,T_ANY,133,DEFAULT_NONE},
{"regexp",F_REGEXP,0,0,2,3,TYPE_ANY,T_STRING|T_ARRAY,T_STRING,T_NUMBER,T_ANY,126,DEFAULT_NONE},
...
{"remove_call_out",F_REMOVE_CALL_OUT,0,0,0,1,TYPE_NUMBER,T_STRING,T_ANY,T_ANY,T_ANY,20,DEFAULT_NONE},
...
{"replaceable",F_REPLACEABLE,0,0,1,2,TYPE_NUMBER,T_OBJECT,T_ARRAY,T_ANY,T_ANY,235,DEFAULT_NONE},
...
{"set_reset",F_SET_RESET,0,0,1,2,TYPE_NOVALUE,T_OBJECT,T_NUMBER,T_ANY,T_ANY,178,DEFAULT_NONE},
{"seteuid",F_SETEUID,0,0,1,1,TYPE_NUMBER,T_STRING|T_NUMBER,T_ANY,T_ANY,T_ANY,99,DEFAULT_NONE},
{"shadow",F_SHADOW,0,0,2,2,TYPE_OBJECT,T_OBJECT,T_NUMBER,T_ANY,T_ANY,178,1},
...
{"snoop",F_SNOOP,0,0,1,2,TYPE_OBJECT,T_OBJECT,T_OBJECT,T_ANY,T_ANY,172,DEFAULT_NONE},
{"socket_accept",F_SOCKET_ACCEPT,0,0,3,3,TYPE_NUMBER,T_NUMBER,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,T_ANY,243,DEFAULT_NONE},
{"socket_acquire",F_SOCKET_ACQUIRE,0,0,4,4,TYPE_NUMBER,T_NUMBER,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,274,DEFAULT_NONE},
{"socket_address",F_SOCKET_ADDRESS,0,0,1,1,TYPE_STRING,T_NUMBER|T_OBJECT,T_ANY,T_ANY,T_ANY,285,DEFAULT_NONE},
...
{"socket_connect",F_SOCKET_CONNECT,0,0,4,4,TYPE_NUMBER,T_NUMBER,T_STRING,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,251,DEFAULT_NONE},
{"socket_create",F_SOCKET_CREATE,0,0,2,3,TYPE_NUMBER,T_NUMBER,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,T_ANY,243,DEFAULT_NONE},
...
{"socket_release",F_SOCKET_RELEASE,0,0,3,3,TYPE_NUMBER,T_NUMBER,T_OBJECT,T_STRING|T_FUNCTION,T_ANY,267,DEFAULT_NONE},
{"socket_write",F_SOCKET_WRITE,0,0,2,3,TYPE_NUMBER,T_NUMBER,T_ANY,T_STRING,T_ANY,261,DEFAULT_NONE},
{"sort_array",F_SORT_ARRAY,0,0,2,-1,TYPE_MOD_ARRAY|TYPE_ANY,T_ARRAY,T_NUMBER|T_STRING|T_FUNCTION,T_ANY,T_ANY,187,DEFAULT_NONE},
...
{"store_variable",F_STORE_VARIABLE,0,0,2,2,TYPE_NOVALUE,T_STRING,T_ANY,T_ANY,T_ANY,239,DEFAULT_NONE},
...
{"terminal_colour",F_TERMINAL_COLOUR,0,0,2,4,TYPE_STRING,T_STRING,T_MAPPING,T_NUMBER,T_NUMBER,227,DEFAULT_NONE},
...
{"unique_mapping",F_UNIQUE_MAPPING,0,0,2,-1,TYPE_MAPPING,T_ARRAY,T_STRING|T_FUNCTION,T_ANY,T_ANY,194,DEFAULT_NONE},
...
{"values",F_VALUES,0,0,1,1,TYPE_MOD_ARRAY|TYPE_ANY,T_MAPPING,T_ANY,T_ANY,T_ANY,116,DEFAULT_NONE},
{"variables",F_VARIABLES,0,0,2,2,TYPE_MOD_ARRAY|TYPE_STRING,T_OBJECT,T_NUMBER,T_ANY,T_ANY,178,0},
...
{"write_buffer",F_WRITE_BUFFER,0,0,3,3,TYPE_NUMBER,T_STRING|T_BUFFER,T_NUMBER,T_STRING|T_BUFFER|T_NUMBER,T_ANY,157,DEFAULT_NONE},
{"write_bytes",F_WRITE_BYTES,0,0,3,3,TYPE_NUMBER,T_STRING,T_NUMBER,T_STRING,T_ANY,93,DEFAULT_NONE},
{"write_file",F_WRITE_FILE,0,0,2,3,TYPE_NUMBER,T_STRING,T_STRING,T_NUMBER,T_ANY,151,DEFAULT_NONE},
